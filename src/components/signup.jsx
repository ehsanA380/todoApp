...
function signup() {
    ...
    return (
        <>
            ...
            {/* <!-- Modal --> */}
                <dialog id="signinModal" className=" absolute top-[50%] left-[50%] translate-[-192px] rounded-xl p-0 backdrop:bg-black/50 ">
                    <form onSubmit={handleSubmit} method="dialog" class=" bg-white p-6 w-96 rounded-xl shadow-lg  ">
